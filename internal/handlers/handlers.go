...
type queueClientReceiver interface {
	ReceiveMessage(messageId string) string
}

type queueClientSender interface {
...
func NewImageDownloadHandler(queueClient queueClientReceiver, httpClient httpClient) *ImageDownload {
...
type ImageDownload struct {
	ImageQueueClient queueClientReceiver
	ImageHttpClient  httpClient
}
...
type MessageProducer struct {
	ImageQueueClient queueClientSender
}

func NewMessageProducerHandler(queueClient queueClientSender) *MessageProducer {
