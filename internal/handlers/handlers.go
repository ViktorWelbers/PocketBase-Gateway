...
type MessageProducer messaging.QueueClient
...
func NewMessageProducerHandler(queueClient *messaging.QueueClient) *MessageProducer {
	messageProducer := MessageProducer(*queueClient)
	return &messageProducer
}

func NewImageDownloadHandler(queueClient *messaging.QueueClient, httpClient *httpclient.ImageHttpClient) *ImageDownload {
...
func (h *MessageProducer) Handle(c echo.Context) error {
	...
	err := message.Send((*messaging.QueueClient)(h))
	if err != nil {
